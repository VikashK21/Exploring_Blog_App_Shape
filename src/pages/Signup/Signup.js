      ...
      <Form onSubmit={signup} className="d-grid gap-2">
        <Row>
          <Form.Group controlId='forText'>
            ...
            <Form.Control size='lg' type="text" placeholder='Example' required
              onChange={(e) => { setUser(pre => ({ ...pre, name: e.target.value })) }} />
          </Form.Group>
          <Form.Group controlId='forEmail'>
            <Form.Label>Email*</Form.Label>
            <Form.Control size='lg' className='mb-2' type="email" placeholder='example@gmail.com' required
              onChange={(e) => { setUser(pre => ({ ...pre, email: e.target.value })) }} />
            <Form.Text>Already have an account? <Button variant='success' onClick={() => navigate('/login')}>Log In</Button></Form.Text>
          </Form.Group>
        </Row>
        <Row>
          <Col md>
            <Form.Group controlId='forNumber'>
              ...
              <Form.Control size='lg' type="number" placeholder='+91 8877665544'
                onChange={(e) => { setUser(pre => ({ ...pre, phone_number: e.target.value })) }} />
            </Form.Group>
          </Col>
          <Col md>
            <Form.Group>
              ...
              <Form.Control size='lg' type="date"
                onChange={(e) => { setUser(pre => ({ ...pre, dob: e.target.value })) }} />
            </Form.Group>
          </Col>
        </Row>
        <Row>
          ...
          <Form.Group>
            ...
            <Form.Control size='lg' type="password" placeholder='Confirm Password...' required
              onChange={(e) => setUser(pre => ({ ...pre, confirm_pass: e.target.value }))} />
          </Form.Group>
        </Row>
